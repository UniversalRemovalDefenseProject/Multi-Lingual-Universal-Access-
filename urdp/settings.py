"""
Django settings for urdp project.
...
# 0.0.0.0 lets the container's runserver be reached from the host; not a prod bind.
...
WSGI_APPLICATION = 'urdp.wsgi.application'
...
LANGUAGE_COOKIE_NAME = 'urdp_language'
